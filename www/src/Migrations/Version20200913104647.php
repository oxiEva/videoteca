 ...
 */
final class Version20200913104647 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE film CHANGE created_at created_at DATETIME NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE film CHANGE created_at created_at DATETIME DEFAULT NULL');
    }
}
